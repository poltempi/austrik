...
export const GET: APIRoute = async () => {
  const env = {
    ...
    NEXT_PUBLIC_SUPABASE_URL: Boolean(
      (import.meta as any).env?.NEXT_PUBLIC_SUPABASE_URL || process.env.NEXT_PUBLIC_SUPABASE_URL
    ),
    ...
    NEXT_PUBLIC_SUPABASE_ANON_KEY: Boolean(
      (import.meta as any).env?.NEXT_PUBLIC_SUPABASE_ANON_KEY || process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY
    ),
